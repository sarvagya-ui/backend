  ...
  onSubmit() {
    switch (this.dbops) {
      case DBOperation.create:
        this._dataService.post(Global.BASE_API_PATH + "UserType/Save/", this.tagForm.value).subscribe(res => {
          if (res.isSuccess) {
      ...
      case DBOperation.update:
        this._dataService.post(Global.BASE_API_PATH + "UserType/Update/", this.tagForm.value).subscribe(res => {
          if (res.isSuccess) {
